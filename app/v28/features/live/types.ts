...
export type Entity={id:string;type:string;owner:string;space:string|null;version:number;created:string;updated:string;data:Record<string,unknown>;members?:{id:string;name:string;handle:string;role:string}[];unread?:number};
